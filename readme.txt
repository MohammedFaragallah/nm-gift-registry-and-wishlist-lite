...
An advanced and highly customizable gift registry and wishlist plugin that allows you to create lists for any occasion.
...
= 2.0.0 =
This is a **new major version** of the plugin. Please **back up** your database and current plugin version if upgrading from version 1.0.0x. See the plugin documentation on installation and updates for further explanation.
