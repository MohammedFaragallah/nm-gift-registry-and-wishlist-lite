...
<td class="purchased-quantity" data-title="<?php esc_attr_e( 'Purchased quantity', 'nm-gift-registry-lite' ); ?>" data-sort-value="<?php echo esc_attr( $purchased_quantity ); ?>">
	...
	<div class="edit" style="display: none;">
		<input type="number"
					 ...
					 name="wishlist_item_purchased_qty[<?php echo absint( $item->get_id() ); ?>]"
					 min="0"
