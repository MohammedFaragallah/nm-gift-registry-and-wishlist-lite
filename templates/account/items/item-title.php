...
<td class="name" data-title="<?php esc_attr_e('Product', 'nm-gift-registry-lite'); ?>"
  data-sort-value="<?php echo esc_attr($product->get_name()); ?>">
  <?php
  ...
  <?php endif;
    ?>
  <input type="hidden" class="wishlist_item_id" name="wishlist_item_id[]"
