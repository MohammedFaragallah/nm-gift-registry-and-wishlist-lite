...
<td class="quantity" data-title="<?php esc_attr_e('Quantity', 'nm-gift-registry-lite'); ?>"
  data-sort-value="<?php echo esc_attr($quantity); ?>">
  ...
  <div class="edit" style="display: none;">
    <input type="number" step="1" placeholder="0" autocomplete="off" size="4" class="quantity"
      value="<?php echo esc_attr($quantity); ?>" data-qty="<?php echo esc_attr($quantity); ?>"
