  ...
  <div class="nmgr-cart-contents">
    <?php
            if (empty($wishlists) || empty($items_and_products)) {
                ...
                $empty_cart_text = sprintf(
                    /* translators %s: wishlist type title */
                    esc_html__('There are currently no items in your %s.', 'nm-gift-registry-lite'),
                    nmgr_get_type_title('', $pluralize)
                );
    ...
    <li class="nmgr-cart-item">
      ...
      <div class="nmgr-cart-item-info">
        <a href="<?php echo esc_url($product->get_permalink()); ?>"
          class="nmgr-cart-item-title"><?php echo esc_html($product->get_name()); ?></a>
      ...
      <div class="nmgr-cart-item-actions">
        ...
        <a href="#" class="nmgr-cart-item-add-to-cart" aria-label="<?php echo $add_item_to_cart_text; ?>"
          title="<?php echo $add_item_to_cart_text; ?>" data-add-to-cart="<?php echo absint($product->get_id()); ?>"
          ...
          data-nmgr-add-to-cart-wishlist="<?php echo absint($item->get_wishlist()->get_id()); ?>" <?php
    ...
    <div class="nmgr-cart-info">
      ...
      <p class="nmgr-cart-total"><strong><?php _e('Subtotal', 'nm-gift-registry-lite'); ?>:</strong>
        <?php echo wc_price($cart_total); ?></p>
      <?php endif; ?>

      <?php do_action('nmgr_cart_info', $wishlists, $template_args); ?>

      <?php if ($show_manage_button) : ?>
      <p class="nmgr-cart-manage"><a href="<?php echo esc_url(nmgr_get_account_url()); ?>"
          class="button"><?php esc_html_e('Manage', 'nm-gift-registry-lite'); ?></a></p>
      <?php endif; ?>
