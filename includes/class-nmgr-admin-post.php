            ...
            switch ($key) {
                ...
                case 'nmgr_ship_to_account_address':
                    ...
                    $fields[ $key ][ 'label' ] = sprintf(
                        /* translators: %s: wishlist type title */
                        __('Ship %s items to user\'s account shipping address', 'nm-gift-registry-lite'),
                        nmgr_get_type_title()
                    );
                    break;
...
<p class="nmgr-user">
  ...
  <select class="nmgr-user-search" id="nmgr_user_id" name="nmgr_user_id"
    data-placeholder="<?php
                            /* translators: %s: wishlist type title */
                            printf(esc_attr__('Enter name of %s owner', 'nm-gift-registry-lite'), esc_html(nmgr_get_type_title())); ?>" data-allow_clear="true">
...
<template id="nmgr-add-items-dialog">
  ...
  <div class="modal-footer">
    <button class="nmgr-add button button-primary">
