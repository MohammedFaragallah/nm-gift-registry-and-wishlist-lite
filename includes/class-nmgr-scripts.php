	...
	private static function get_script_data( $handle = '' ) {
		...
		$global_params = array(
			...
			'i18n_delete_item_text' => sprintf(
				...
				esc_attr__( 'Are you sure you want to remove the %s item?', 'nm-gift-registry-lite' ), esc_html( nmgr_get_type_title() ) ),
		...
		$data[ 'nmgr-frontend' ] = array(
			...
			'i18n_select_product_text' => sprintf(
				/* translators: %s: wishlist type title */
				esc_attr__( 'Please select an item to add to your %s.', 'nm-gift-registry-lite' ), esc_html( nmgr_get_type_title() ) ),
			'i18n_select_quantity_text' => sprintf(
				/* translators: %s: wishlist type title */
				esc_attr__( 'Please choose the quantity of items you wish to add to your %s.', 'nm-gift-registry-lite' ), esc_html( nmgr_get_type_title() ) ),
